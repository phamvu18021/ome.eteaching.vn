...
export default function ProductDetailPage() {
  ...
  const breadcrumbItems = [
    ...
    { label: product.info.category, href: "/danh-muc-san-pham" },
    { label: product.name },
  ];
    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="container mx-auto px-6 py-16 max-w-[1540px]">
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <main className="flex-1 lg:min-w-0">
            ...
            <div className="lg:hidden mb-4">
              ...
              >
                ...
                <span className="text-sm font-medium">Thông tin & Bộ lọc</span>
              </button>
            </div>
          ...
          {/* Sidebar */}
          <aside
            className={`fixed lg:static inset-0 z-[60] lg:z-0 bg-white lg:bg-transparent transition-transform duration-300 ${
              isSidebarOpen
                ? "translate-x-0"
